  ...
  <div>
    ...
    <el-form ref="form" :model="form" :rules="rules" :validate-on-rule-change="false" status-icon label-position="top" label-width="100px">
      <el-form-item label="App ID" prop="feishuAppId">
        ...
        <div class="help-block" style="color: #999; font-size: 12px">登录《<a href="https://open.feishu.cn" target="_blank" style="color: #66b1ff">飞书开放平台</a>》，在创建的企业自建应用详情页中，从左侧的【凭证与基础信息】中获取。</div>
      </el-form-item>
