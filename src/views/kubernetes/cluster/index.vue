<template>
  <div class="app-container">
    ...
    <el-row :gutter="10">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd">添加集群</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-refresh" size="mini">全量同步</el-button>
      </el-col>
    </el-row>
    ...
    <!-- 编辑 -->
    <el-dialog
      v-if="clusterAddDialog"
      :title="formTitle"
      :visible.sync="clusterAddDialog"
      :show-close="false"
      width="700px"
...
import { getKubernetesList, addCluster, changeCluster, deleteCluster } from '@/api/kubernetes/cluster'
import ClusterTable from './table'
import ClusterAddForm from './form'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      getKubernetesList(this.queryParams).then((res) => {
